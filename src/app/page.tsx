    ...
    <>
      <div className="py-4 px-6 flex justify-around max-425:flex-col-reverse">
        <div className="flex flex-col justify-center max-425:mt-4 max-425:text-center">
          ...
          <div className="h-8 px-2 mt-4 rounded-md flex items-center gap-2 bg-white shadow-sm hover:shadow-md dark:text-slate-400 max-425:justify-center">
            ...
            <Link href="https://blog.ciraos.top" className="px-1 border-l-[1px] border-solid border-black hover:underline-offset-1 hover:underline">博客</Link>
            <Link href="https://pan.ciraos.top" target="_blank" rel="noopener noreferrer" className="hover:underline-offset-1 hover:underline">网盘</Link>
            <Link href="https://stat.ciraos.top/status/myserver" target="_blank" rel="noopener noreferrer" className="hover:underline-offset-1 hover:underline">监控</Link>
          </div>
        </div>
